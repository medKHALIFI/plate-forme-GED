...
{ 
  ...
  this.nodeImg = 0;
  this.isLastNode = 0;
  this.iconSrc = ICONPATH + "openedfolder.gif";
...
{ 
  ...
  this.iconSrc = ICONPATH + "ftvimage.gif" 
  this.isRendered = 0
  this.isLastNode = false
  this.level = 0
  this.leftSideCoded = ""
...
function preLoadIcons() {
	...
	auxImg.src = ICONPATH + "ftvimage.gif";
}
...
//To customize the tree, overwrite these variables in the configuration file (FramesetNode.js, etc.)
var USETEXTLINKS = 0 
var STARTALLOPEN = 0
var USEFRAMES = 1
var USEICONS = 1
...
{ 
  ...
  //foldersTree (with the site's data) is created in an external .js (FramesetNode.js, for example)
